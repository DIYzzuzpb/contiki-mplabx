...
#line 65 "/home/jarojuda/contiki/core/net/rime/rudolph2.h"
...
#line 82 "/home/jarojuda/contiki/core/net/rime/rudolph2.h"
struct rudolph2_conn {
...
#line 64 "/home/jarojuda/contiki/core/cfs/cfs.h"
typedef int cfs_offset_t;
#line 69 "/home/jarojuda/contiki/core/cfs/cfs.h"
struct cfs_dir {
char dummy_space[32];
};
...
#line 166 "/home/jarojuda/contiki/core/cfs/cfs.h"
int cfs_open(const char *name, int flags);
#line 177 "/home/jarojuda/contiki/core/cfs/cfs.h"
void cfs_close(int fd);
#line 192 "/home/jarojuda/contiki/core/cfs/cfs.h"
int cfs_read(int fd, void *buf, unsigned int len);
#line 207 "/home/jarojuda/contiki/core/cfs/cfs.h"
int cfs_write(int fd, const void *buf, unsigned int len);
#line 228 "/home/jarojuda/contiki/core/cfs/cfs.h"
cfs_offset_t cfs_seek(int fd, cfs_offset_t offset, int whence);
#line 238 "/home/jarojuda/contiki/core/cfs/cfs.h"
int cfs_remove(const char *name);
#line 251 "/home/jarojuda/contiki/core/cfs/cfs.h"
int cfs_opendir(struct cfs_dir *dirp, const char *name);
#line 265 "/home/jarojuda/contiki/core/cfs/cfs.h"
int cfs_readdir(struct cfs_dir *dirp, struct cfs_dirent *dirent);
#line 276 "/home/jarojuda/contiki/core/cfs/cfs.h"
void cfs_closedir(struct cfs_dir *dirp);
#line 64 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
struct rudolph2_hdr {
uint8_t type;
uint8_t hops_from_base;
uint16_t version;
...
#line 75 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
enum {
TYPE_DATA,
TYPE_NACK,
};
#line 95 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
static int
...
if(c->cb->read_chunk) {
len = c->cb->read_chunk(c, chunk * 64,
dataptr, 64);
}
return len;
}
...
;
#line 142 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
if(datalen < 64) {
;
#line 146 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
c->cb->write_chunk(c, chunk * 64,
...
polite_send(&c->c, interval, 1);
;
#line 165 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
return len;
}
...
;
polite_send(&c->c, 1000 / 4, 1);
}
#line 217 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
static void
sent(struct polite_conn *polite)
{
#line 231 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
}

static void
dropped(struct polite_conn *polite)
{
#line 245 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
}
...
if((c->flags & 0x04) == 0 &&
(c->flags & 0x02)) {
#line 263 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
if(c->flags & 0x01) {
interval = 1000 * 16;
} else {
interval = 1000 / 2;
}
#line 270 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
...
#line 297 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
if(hdr->type == TYPE_NACK && hdr->hops_from_base > c->hops_from_base) {
c->nacks++;
;
#line 303 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
if(hdr->version == c->version) {
if(hdr->chunk < c->rcv_nxt) {
c->snd_nxt = hdr->chunk;
send_data(c, 1000 / 2);
}
} else if(((signed short)((hdr->version) - ( c->version)) < 0)) {
c->snd_nxt = 0;
send_data(c, 1000 / 2);
}
} else if(hdr->type == TYPE_DATA) {
if(hdr->hops_from_base < c->hops_from_base) {
#line 316 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
c->hops_from_base = hdr->hops_from_base + 1;
if(((signed short)((c->version) - ( hdr->version)) < 0)) {
;
#line 321 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
...
;
#line 336 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
if(hdr->chunk == c->rcv_nxt) {
int len;
packetbuf_hdrreduce(sizeof(struct rudolph2_hdr));
;
#line 342 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
len = packetbuf_totlen();
write_data(c, hdr->chunk, packetbuf_dataptr(), packetbuf_totlen());
c->rcv_nxt++;
if(len < 64) {
c->flags |= 0x02;
send_data(c, 1000 / 2 * 4);
ctimer_set(&c->t, 1000 / 2 * 4, timed_send, c);
}
} else if(hdr->chunk > c->rcv_nxt) {
;
#line 354 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph2.c"
send_nack(c);
} else if(hdr->chunk < c->rcv_nxt) {
...
len = 64;
packetbuf_clear();
for(c->rcv_nxt = 0; len == 64; c->rcv_nxt++) {
len = read_data(c, packetbuf_dataptr(), c->rcv_nxt);
}
c->flags = 0x02;

send_data(c, 1000 / 2);
ctimer_set(&c->t, 1000 / 2, timed_send, c);
}
