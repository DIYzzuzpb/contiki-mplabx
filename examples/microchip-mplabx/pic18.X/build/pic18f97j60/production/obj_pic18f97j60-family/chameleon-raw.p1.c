...
#line 64 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
struct raw_hdr {
uint8_t channel[2];
};
#line 69 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
...
struct raw_hdr *hdr;
struct channel *c;
#line 80 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
...
#line 106 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
;
len = (a->len & 0xf8) + ((a->len & 7) ? 8: 0);
if(((a->type) >= PACKETBUF_ADDR_SENDER)) {
const rimeaddr_t addr;
memcpy((uint8_t *)&addr, &hdrptr[byteptr], len / 8);
#line 113 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
;
packetbuf_set_addr(a->type, &addr);
} else {
packetbuf_attr_t val = 0;
memcpy((uint8_t *)&val, &hdrptr[byteptr], len / 8);
#line 121 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
packetbuf_set_attr(a->type, val);
;
#line 125 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
}
byteptr += len / 8;
}
return c;
...
uint8_t *hdrptr;
struct raw_hdr *hdr;
#line 141 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
...
byteptr = 0;
for(a = c->attrlist; a->type != PACKETBUF_ATTR_NONE; ++a) {
#line 160 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
;
len = (a->len & 0xf8) + ((a->len & 7) ? 8: 0);
if(((a->type) >= PACKETBUF_ADDR_SENDER)) {
const rimeaddr_t *rimeaddr;
#line 167 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
...
#line 179 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
;
}
byteptr += len / 8;
}
#line 186 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
return 1; 
}
...
{
int size, len;
#line 197 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
size = 0;
for(; a->type != PACKETBUF_ATTR_NONE; ++a) {
#line 208 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/chameleon-raw.c"
len = a->len;
if(len < 8) {
len = 8;
}
