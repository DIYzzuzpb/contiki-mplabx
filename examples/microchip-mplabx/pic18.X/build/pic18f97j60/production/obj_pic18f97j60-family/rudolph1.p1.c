...
#line 66 "/home/jarojuda/contiki/core/net/rime/rudolph1.h"
...
#line 57 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
struct rudolph1_hdr {
uint8_t type;
uint8_t version;
uint16_t chunk;
};
#line 65 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
...
#line 87 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
static int
...
if(datalen < 64) {
;
#line 127 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
...
;
ipolite_send(&c->ipolite, 1000 / 4, sizeof(struct rudolph1_hdr));
}
#line 153 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
static void
handle_data(struct rudolph1_conn *c, struct rudolph1_datapacket *p)
{
if(((signed char)((c->version) - ( p->h.version)) < 0)) {
;
#line 160 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
...
;
#line 174 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
if(p->h.chunk == c->chunk) {
;
#line 178 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
...
;
#line 187 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
send_nack(c);
c->highest_chunk_heard = p->h.chunk;
} else if(p->h.chunk < c->chunk) {

}
#line 196 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
...
;
#line 215 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
handle_data(c, p);
}
}
...
;
#line 244 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
c->nacks++;

if(p->h.type == TYPE_NACK) {
;
#line 251 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
...
} else if(((signed char)((p->h.version) - ( c->version)) < 0)) {
format_data(c, 0);
ipolite_send(&c->ipolite, c->send_interval / 2, sizeof(struct rudolph1_hdr));
}
} else if(p->h.type == TYPE_DATA) {
#line 266 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
;
handle_data(c, p);
}
}
#line 273 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
static void
...
;
#line 288 "/home/jarojuda/contiki-mplabx/examples/microchip-mplabx/pic18.X/../../../../contiki/core/net/rime/rudolph1.c"
c->highest_chunk_heard = c->chunk;
c->chunk++;
...
const struct rudolph1_callbacks *cb)
{
trickle_open(&c->trickle, 1000 / 2, channel, &trickle);
ipolite_open(&c->ipolite, channel + 1, 1, &ipolite);
c->cb = cb;
c->version = 0;
c->send_interval = 1000 * 2;
}
