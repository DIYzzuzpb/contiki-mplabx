...
//#define DSPICDEM11
//#define DSPICDEMNET1		// Not currently supported, wrong Ethernet controller
//#define DSPICDEMNET2		// Not currently supported, wrong Ethernet controller
//#define YOUR_BOARD
...
#if !defined(PICDEMNET2) && !defined(HPC_EXPLORER) && !defined(PICDEMZ) && !defined(EXPLORER_16) && !defined(PIC24FJ64GA004_PIM) && !defined(DSPICDEM11) && !defined(DSPICDEMNET1) && !defined(DSPICDEMNET2) && !defined(PICDEMNET2) && !defined(INTERNET_RADIO) && !defined(YOUR_BOARD)
...
// This value is used to calculate Tick Counter value
	...
	// All PIC18 processors
		...
		#define CLOCK_FREQ		(16000000ul)		// Hz
//		#define CLOCK_FREQ		(25000000ul)		// Using ENC28J60 Clockout
	#else
		#define CLOCK_FREQ		(40000000ul)      // Hz
	#endif
#elif defined(__PIC24F__)	
	// PIC24F processor
	#define CLOCK_FREQ			(32000000ul)      // Hz
...
#elif defined(__dsPIC30F__)
	// dsPIC30F processor
	#define CLOCK_FREQ			(117920000ul)      // Hz
#elif defined(__PIC32MX__)
	// PIC32MX processor
	#define CLOCK_FREQ			(72000000ul)      // Hz
	#define PERIPHERAL_FREQ		(CLOCK_FREQ/1ul)  // Set your divider according to your Peripheral Bus Frequency configuration fuse setting
#endif
...
// Explorer 16 + PIC24FJ64GA004 PIM + Ethernet PICtail Plus
	...
	#define ENC_SDI_TRIS		(TRISCbits.TRISC1)
	#define ENC_SDO_TRIS		(TRISCbits.TRISC0)
...
// Explorer 16 + PIC32MX360F512L + Ethernet PICtail Plus
...
#else	 // PIC24F, PIC24H, dsPIC30, dsPIC33, PIC32MX
