...
#line 51 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/lib/memb.c"
void
...
for(i = 0; i < m->num; ++i) {
if(m->count[i] == 0) {
#line 68 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/lib/memb.c"
++(m->count[i]);
return (void *)((char *)m->mem + (i * m->size));
}
}
#line 75 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/lib/memb.c"
return 0;
}
...
int i;
char *ptr2;
#line 86 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/lib/memb.c"
ptr2 = (char *)m->mem;
for(i = 0; i < m->num; ++i) {

if(ptr2 == (char *)ptr) {
#line 92 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/lib/memb.c"
if(m->count[i] > 0) {
