...
#line 34 "/home/jarojuda/GitHub/contiki/core/dev/sht11.h"
...
#line 44 "/home/jarojuda/GitHub/contiki/core/dev/sht11-sensor.h"
extern const struct sensors_sensor sht11_sensor;
#line 40 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/dev/sht11-sensor.c"
...
#line 48 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/dev/sht11-sensor.c"
static int
value(int type)
{
switch(type) {
...
case 0:
return sht11_temp();;
#line 57 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/dev/sht11-sensor.c"
case 1:
...
#line 78 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/dev/sht11-sensor.c"
static int
...
sht11_init();
state = ON;
#line 90 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/dev/sht11-sensor.c"
t0 = rtimer_arch_now();
while(((int16_t)((rtimer_arch_now())-( t0 + ((((41666667ul)/4)+128ull)/256ull) / 100))<0));
}
} else {
sht11_off();
state = OFF;
...
const struct sensors_sensor sht11_sensor = { "sht11", value, configure, status };
