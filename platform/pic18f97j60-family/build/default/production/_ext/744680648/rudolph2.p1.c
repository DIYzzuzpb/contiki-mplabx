...
#line 65 "/home/jarojuda/GitHub/contiki/core/net/rime/rudolph2.h"
...
#line 82 "/home/jarojuda/GitHub/contiki/core/net/rime/rudolph2.h"
struct rudolph2_conn {
...
#line 64 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
struct rudolph2_hdr {
uint8_t type;
uint8_t hops_from_base;
uint16_t version;
...
#line 75 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
enum {
TYPE_DATA,
TYPE_NACK,
};
#line 95 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
static int
...
;
#line 142 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
if(datalen < 64) {
;
#line 146 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
...
;
#line 165 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
return len;
}
...
;
polite_send(&c->c, ((((41666667ul)/4)+128ull)/256ull) / 4, 1);
}
#line 217 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
static void
sent(struct polite_conn *polite)
{
#line 231 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
}

static void
dropped(struct polite_conn *polite)
{
#line 245 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
}
...
if((c->flags & 0x04) == 0 &&
(c->flags & 0x02)) {
#line 263 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
if(c->flags & 0x01) {
interval = ((((41666667ul)/4)+128ull)/256ull) * 16;
} else {
interval = ((((41666667ul)/4)+128ull)/256ull) / 2;
}
#line 270 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
...
#line 297 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
if(hdr->type == TYPE_NACK && hdr->hops_from_base > c->hops_from_base) {
c->nacks++;
;
#line 303 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
if(hdr->version == c->version) {
if(hdr->chunk < c->rcv_nxt) {
c->snd_nxt = hdr->chunk;
send_data(c, ((((41666667ul)/4)+128ull)/256ull) / 2);
}
...
#line 316 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
c->hops_from_base = hdr->hops_from_base + 1;
if(((signed short)((c->version) - ( hdr->version)) < 0)) {
;
#line 321 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
...
;
#line 336 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
if(hdr->chunk == c->rcv_nxt) {
int len;
packetbuf_hdrreduce(sizeof(struct rudolph2_hdr));
;
#line 342 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
len = packetbuf_totlen();
write_data(c, hdr->chunk, packetbuf_dataptr(), packetbuf_totlen());
c->rcv_nxt++;
if(len < 64) {
c->flags |= 0x02;
send_data(c, ((((41666667ul)/4)+128ull)/256ull) / 2 * 4);
ctimer_set(&c->t, ((((41666667ul)/4)+128ull)/256ull) / 2 * 4, timed_send, c);
}
} else if(hdr->chunk > c->rcv_nxt) {
;
#line 354 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph2.c"
send_nack(c);
} else if(hdr->chunk < c->rcv_nxt) {
...
send_data(c, ((((41666667ul)/4)+128ull)/256ull) / 2);
ctimer_set(&c->t, ((((41666667ul)/4)+128ull)/256ull) / 2, timed_send, c);
}
