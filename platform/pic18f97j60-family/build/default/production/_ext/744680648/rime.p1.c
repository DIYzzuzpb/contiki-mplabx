...
#line 62 "/home/jarojuda/GitHub/contiki/core/net/rime/broadcast-announcement.h"
...
#line 88 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rime.c"
static void *sniffers_list = 0; static list_t sniffers = (list_t)&sniffers_list;
#line 91 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rime.c"
void
...
chameleon_init();
#line 140 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rime.c"
broadcast_announcement_init(2,
((((41666667ul)/4)+128ull)/256ull) * 32 / 8,
((((41666667ul)/4)+128ull)/256ull) * 60,
((((41666667ul)/4)+128ull)/256ull) * 3600UL);
}
...
#line 167 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rime.c"
for(s = list_head(sniffers); s != 0; s = list_item_next(s)) {
if(s->output_callback != 0) {
...
nullmac_driver.send(packet_sent, c);
return 1;
}
return 0;
}
