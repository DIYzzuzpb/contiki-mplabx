...
#include <string.h>
#line 47 "/home/jarojuda/GitHub/contiki/core/sys/timetable.h"
struct timetable_timestamp {
const char *id;
rtimer_clock_t time;
#line 53 "/home/jarojuda/GitHub/contiki/core/sys/timetable.h"
};
struct timetable {
...
#line 123 "/home/jarojuda/GitHub/contiki/core/sys/timetable.h"
extern rtimer_clock_t timetable_timestamp_time;
#line 126 "/home/jarojuda/GitHub/contiki/core/sys/timetable.h"
...
#line 46 "/home/jarojuda/GitHub/contiki/core/sys/timetable-aggregate.h"
...
#line 79 "/home/jarojuda/GitHub/contiki/core/sys/timetable-aggregate.h"
...
struct timetable *timetable);
#line 56 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rucb.c"
static int
...
packetbuf_clear();
if(c->u->read_chunk) {
len = c->u->read_chunk(c, c->chunk * 64,
packetbuf_dataptr(), 64);
}
...
if(len >= 0) {
runicast_send(&c->c, &c->receiver, 8);
c->last_size = len;
#line 91 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rucb.c"
}
}
...
;
#line 114 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rucb.c"
...
#line 126 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rucb.c"
if(rimeaddr_cmp(&c->sender, from)) {
int datalen = packetbuf_datalen();

if(datalen < 64) {
;
#line 133 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rucb.c"
c->u->write_chunk(c, c->chunk * 64,
