...
#line 63 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
static char collect_neighbors_mem_memb_count[ 8]; static struct collect_neighbor collect_neighbors_mem_memb_mem[ 8]; static struct memb collect_neighbors_mem = {sizeof( struct collect_neighbor), 8, collect_neighbors_mem_memb_count, (void *)collect_neighbors_mem_memb_mem};
#line 81 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
static void
periodic(void *ptr)
{
struct collect_neighbor_list *neighbor_list;
...
neighbor_list = ptr;
#line 90 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
for(n = list_head(neighbor_list->list); n != 0; n = list_item_next(n)) {
n->age++;
n->le_age++;
}
for(n = list_head(neighbor_list->list); n != 0; n = list_item_next(n)) {
...
ctimer_set(&neighbor_list->periodic, ((((41666667ul)/4)+128ull)/256ull) * 60,
...
{
do { (neighbors_list)-> list = &((neighbors_list)->list_list); (neighbors_list)->list_list = 0; list_init((neighbors_list)-> list); } while(0);
list_init(neighbors_list->list);
ctimer_set(&neighbors_list->periodic, ((((41666667ul)/4)+128ull)/256ull), periodic, neighbors_list);
}
...
for(n = list_head(neighbors_list->list); n != 0; n = list_item_next(n)) {
...
;
#line 161 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
for(n = list_head(neighbors_list->list); n != 0; n = list_item_next(n)) {
if(rimeaddr_cmp(&n->addr, addr)) {
;
...
#line 171 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
if(n == 0) {
;
...
#line 184 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
if(n == 0) {
uint16_t worst_rtmetric;
struct collect_neighbor *worst_neighbor;
#line 193 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
worst_rtmetric = 0;
worst_neighbor = 0;
...
#line 206 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
...
#line 270 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
;
#line 273 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
for(n = list_head(neighbors_list->list); n != 0; n = list_item_next(n)) {
;
#line 278 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
...
while(list_head(neighbors_list->list) != 0) {
...
if(n != 0) {
;
#line 342 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
n->rtmetric = rtmetric;
n->age = 0;
}
}
...
#line 390 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/collect-neighbor.c"
return collect_link_estimate(&n->le) + 8 * 8;
} else {
...
timer_set(&n->congested_timer, ((((41666667ul)/4)+128ull)/256ull) * 240);
}
