...
#include <string.h>
#line 58 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/stunicast.c"
static void
recv_from_uc(struct unicast_conn *uc, const rimeaddr_t *from)
{
register struct stunicast_conn *c = (struct stunicast_conn *)uc;
;
#line 65 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/stunicast.c"
if(c->u->recv != 0) {
c->u->recv(c, from);
}
}
...
register struct stunicast_conn *c = (struct stunicast_conn *)uc;
;
#line 78 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/stunicast.c"
if(c->u->sent != 0) {
...
stunicast_set_timer(c, ((((41666667ul)/4)+128ull)/256ull));
}
#line 123 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/stunicast.c"
}
...
;
unicast_send(&c->c, &c->receiver);
#line 153 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/stunicast.c"
return 1;
...
{
;
#line 163 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/stunicast.c"
