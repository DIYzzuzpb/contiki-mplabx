...
#line 68 "/home/jarojuda/GitHub/contiki/core/net/rime/stbroadcast.h"
...
#line 80 "/home/jarojuda/GitHub/contiki/core/net/rime/stbroadcast.h"
struct stbroadcast_conn {
struct broadcast_conn c;
struct ctimer t;
struct queuebuf *buf;
...
#line 103 "/home/jarojuda/GitHub/contiki/core/net/rime/stbroadcast.h"
void stbroadcast_open(struct stbroadcast_conn *c, uint16_t channel,
const struct stbroadcast_callbacks *u);
void stbroadcast_close(struct stbroadcast_conn *c);
#line 122 "/home/jarojuda/GitHub/contiki/core/net/rime/stbroadcast.h"
int stbroadcast_send_stubborn(struct stbroadcast_conn *c, clock_time_t t);
#line 134 "/home/jarojuda/GitHub/contiki/core/net/rime/stbroadcast.h"
void stbroadcast_cancel(struct stbroadcast_conn *c);
#line 148 "/home/jarojuda/GitHub/contiki/core/net/rime/stbroadcast.h"
void stbroadcast_set_timer(struct stbroadcast_conn *c, clock_time_t t);
#line 65 "/home/jarojuda/GitHub/contiki/core/net/rime/rudolph0.h"
...
#line 86 "/home/jarojuda/GitHub/contiki/core/net/rime/rudolph0.h"
struct rudolph0_hdr {
uint8_t type;
uint8_t version;
uint16_t chunk;
...
#line 114 "/home/jarojuda/GitHub/contiki/core/net/rime/rudolph0.h"
...
#line 53 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph0.c"
enum {
TYPE_DATA,
TYPE_NACK,
};
...
#line 74 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/rime/rudolph0.c"
static void
...
if(c->cb->read_chunk) {
len = c->cb->read_chunk(c, c->current.h.chunk * 64,
c->current.data, 64);
}
...
if(c->current.datalen == 64) {
c->current.h.chunk++;
;
read_new_datapacket(c);
} else {
stbroadcast_set_timer(&c->c, ((((41666667ul)/4)+128ull)/256ull) * 2);
;
...
;
if(p->datalen < 64) {
c->cb->write_chunk(c, c->current.h.chunk * 64,
