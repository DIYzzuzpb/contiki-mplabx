...
#include <string.h>
#line 60 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
struct queuebuf {
#line 71 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
struct queuebuf_data *ram_ptr;
#line 76 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
};
#line 79 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
struct queuebuf_data {
uint16_t len;
uint8_t data[128];
struct packetbuf_attr attrs[(PACKETBUF_ATTR_MAX - 4)];
struct packetbuf_addr addrs[4];
};
...
static char bufmem_memb_count[ 8]; static struct queuebuf bufmem_memb_mem[ 8]; static struct memb bufmem = {sizeof( struct queuebuf), 8, bufmem_memb_count, (void *)bufmem_memb_mem};
static char refbufmem_memb_count[ 2]; static struct queuebuf_ref refbufmem_memb_mem[ 2]; static struct memb refbufmem = {sizeof( struct queuebuf_ref), 2, refbufmem_memb_count, (void *)refbufmem_memb_mem};
static char buframmem_memb_count[ 8]; static struct queuebuf_data buframmem_memb_mem[ 8]; static struct memb buframmem = {sizeof( struct queuebuf_data), 8, buframmem_memb_count, (void *)buframmem_memb_mem};
#line 285 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
static struct queuebuf_data *
queuebuf_load_to_ram(struct queuebuf *b)
{
return b->ram_ptr;
}
#line 292 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
void
queuebuf_init(void)
{
#line 302 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
memb_init(&buframmem);
memb_init(&bufmem);
memb_init(&refbufmem);
#line 308 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
}
#line 314 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
struct queuebuf *
queuebuf_new_from_packetbuf(void)
{
struct queuebuf *buf;
struct queuebuf_ref *rbuf;
#line 321 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
if(packetbuf_is_reference()) {
rbuf = memb_alloc(&refbufmem);
if(rbuf != 0) {
#line 327 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
...
if(buf != 0) {
#line 344 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
buf->ram_ptr = memb_alloc(&buframmem);
#line 357 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
if(buf->ram_ptr == 0) {
;
return 0;
}
buframptr = buf->ram_ptr;
#line 364 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
buframptr->len = packetbuf_copyto(buframptr->data);
packetbuf_attr_copyto(buframptr->attrs, buframptr->addrs);
#line 388 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
} else {
;
}
return buf;
...
packetbuf_attr_copyto(buframptr->attrs, buframptr->addrs);
#line 405 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
}
...
#line 418 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
memb_free(&buframmem, buf->ram_ptr);
memb_free(&bufmem, buf);
#line 428 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
} else if(memb_inmemb(&refbufmem, buf)) {
memb_free(&refbufmem, buf);
#line 433 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
}
}
...
{
struct queuebuf_data *buframptr = queuebuf_load_to_ram(b);
return &buframptr->addrs[type - PACKETBUF_ADDR_SENDER].addr;
}
...
{
#line 501 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/queuebuf.c"
}
