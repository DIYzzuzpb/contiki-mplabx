...
#line 40 "/home/jarojuda/GitHub/contiki/core/net/uip-fw-drv.h"
...
#line 75 "/home/jarojuda/GitHub/contiki/core/net/uiplib.h"
...
#line 58 "/home/jarojuda/GitHub/contiki/core/net/simple-udp.h"
...
#line 57 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
extern process_event_t resolv_event_found;
#line 60 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
void resolv_conf(const uip_ipaddr_t * dnsserver);

uip_ipaddr_t *resolv_getserver(void);

enum {
#line 67 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
RESOLV_STATUS_CACHED = 0,
#line 70 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
RESOLV_STATUS_UNCACHED,
#line 75 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
RESOLV_STATUS_EXPIRED,
#line 83 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
RESOLV_STATUS_NOT_FOUND,
#line 86 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
RESOLV_STATUS_RESOLVING,
#line 92 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
RESOLV_STATUS_ERROR,
};
...
#line 102 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
void resolv_set_hostname(const char *hostname);

const char *resolv_get_hostname(void);
#line 107 "/home/jarojuda/GitHub/contiki/core/net/resolv.h"
...
#line 101 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
struct psock_buf {
uint8_t *ptr;
unsigned short left;
};
#line 112 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
struct psock {
struct pt pt, psockpt; 
#line 116 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
const uint8_t *sendptr; 
uint8_t *readptr; 

uint8_t *bufptr; 
#line 122 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
uint16_t sendlen; 
uint16_t readlen; 
...
#line 166 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
char psock_send(struct psock *psock, const uint8_t *buf, unsigned int len);
#line 200 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
char psock_generator_send(struct psock *psock, unsigned short (*f)(void *), void *arg);
#line 243 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
char psock_readbuf_len(struct psock *psock, uint16_t len);
#line 276 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
char psock_readto(struct psock *psock, unsigned char c);
#line 306 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
uint16_t psock_datalen(struct psock *psock);
#line 350 "/home/jarojuda/GitHub/contiki/core/net/psock.h"
...
#line 107 "/home/jarojuda/GitHub/contiki/core/net/netstack.h"
struct network_driver {
char *name;
#line 111 "/home/jarojuda/GitHub/contiki/core/net/netstack.h"
void (* init)(void);
#line 114 "/home/jarojuda/GitHub/contiki/core/net/netstack.h"
void (* input)(void);
};
...
#include <string.h>
#include <stdio.h>
#line 38 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
struct ip_hdr {
...
#line 60 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
struct tcpip_hdr {
...
#line 88 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
struct icmpip_hdr {
...
uint8_t srcipaddr[4],
destipaddr[4];
#line 102 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
uint8_t type, icode;
uint16_t icmpchksum;
uint16_t id, seqno;
};
#line 109 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
struct udpip_hdr {
...
uint8_t srcipaddr[4],
destipaddr[4];
#line 123 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
uint16_t srcport,
destport;
uint16_t udplen;
uint16_t udpchksum;
};
#line 137 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
static void
...
{
char flags[8];
if(((struct ip_hdr *)&packet[0])->proto == 1) {
if(((struct icmpip_hdr *)&packet[0])->type == 8) {
return s(" ping",
n(((struct ip_hdr *)&packet[0])->destipaddr[3], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[2], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[1], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[0],
s(" ",
n(((struct ip_hdr *)&packet[0])->srcipaddr[3], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[2], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[1], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[0],
buf)))))))))))))))) - buf;
#line 220 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
} else if(((struct icmpip_hdr *)&packet[0])->type == 0) {
return s(" pong",
n(((struct ip_hdr *)&packet[0])->destipaddr[3], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[2], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[1], d(
...
n(((struct ip_hdr *)&packet[0])->srcipaddr[0],
buf)))))))))))))))) - buf;
#line 237 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
}
} else if(((struct ip_hdr *)&packet[0])->proto == 17) {
return s(" UDP",
n(uip_htons(((struct udpip_hdr *)&packet[0])->destport), d(
n(((struct ip_hdr *)&packet[0])->destipaddr[3], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[2], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[1], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[0],
s(" ",
n(uip_htons(((struct udpip_hdr *)&packet[0])->srcport), d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[3], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[2], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[1], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[0],
buf)))))))))))))))))))) - buf;
#line 259 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
} else if(((struct ip_hdr *)&packet[0])->proto == 6) {
tcpflags(((struct tcpip_hdr *)&packet[0])->flags, flags);
return s(flags,
s(" ",
n(uip_htons(((struct tcpip_hdr *)&packet[0])->destport), d(
n(((struct ip_hdr *)&packet[0])->destipaddr[3], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[2], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[1], d(
n(((struct ip_hdr *)&packet[0])->destipaddr[0],
s(" ",
n(uip_htons(((struct tcpip_hdr *)&packet[0])->srcport), d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[3], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[2], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[1], d(
n(((struct ip_hdr *)&packet[0])->srcipaddr[0],
buf))))))))))))))))))))) - buf;
#line 283 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/tcpdump.c"
} else {
