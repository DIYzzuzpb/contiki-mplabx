...
#line 42 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/uip-udp-packet.c"
...
#include <string.h>
#line 49 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/uip-udp-packet.c"
void
...
uip_udp_conn = c;
uip_slen = len;
memcpy(&(uip_aligned_buf.u8)[14 + (8 + 20)], data,
len > (1280 + 14) - 14 - (8 + 20)?
(1280 + 14) - 14 - (8 + 20): len);
uip_process(4);
#line 63 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/uip-udp-packet.c"
if(uip_len > 0) {
tcpip_output();
}
}
...
#line 72 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/uip-udp-packet.c"
void
...
(*(&curaddr) = *( &c->ripaddr));
curport = c->rport;
#line 85 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/uip-udp-packet.c"
(*(&c->ripaddr) = *( toaddr));
c->rport = toport;

uip_udp_packet_send(c, data, len);
#line 91 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/uip-udp-packet.c"
(*(&c->ripaddr) = *( &curaddr));
c->rport = curport;
}
}
