...
#line 46 "/home/jarojuda/GitHub/contiki/core/net/mac/nullrdc-noframer.h"
...
#include <string.h>
#line 47 "/home/jarojuda/GitHub/contiki-mplabx/platform/pic18f97j60-family/../../../contiki/core/net/mac/nullrdc-noframer.c"
static void
send_packet(mac_callback_t sent, void *ptr)
{
int ret;
if(nullradio_driver.send(packetbuf_hdrptr(), packetbuf_totlen()) == RADIO_TX_OK) {
ret = MAC_TX_OK;
} else {
ret = MAC_TX_ERR;
}
